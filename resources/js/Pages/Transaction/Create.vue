<template>
    ...
    <form @submit.prevent="store" class="mx-auto mt-5 max-w-xl">
        <div class="mb-5">
            ...
            <DangerAlert v-if="form.errors.sum" :message="form.errors.sum"/>
        </div>
        <div class="mb-5">
            ...
            <DangerAlert v-if="form.errors.description" :message="form.errors.description"/>
        </div>
        <div class="mb-5">
